...
setup(
    ...
    description='Robô Laura Sentry Capture Exception',
    ...
    download_url='https://github.com/Wrsanches/rlsce/archive/v0.1.tar.gz',
    # Keywords that define your package best
    keywords=['Robô', 'Laura', 'Sentry', 'Capture', 'Exception'],
